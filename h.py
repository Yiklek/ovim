...
def uninstall(parser, args):
    ...
    try:
        ...
        print("delete config dir %s failed. please remove %s manually." % (vim_config_path, vim_config_path))
    if args.remove_cache:
        try:
            shutil.rmtree(ovim_cache_dir)
            print("delete config dir %s successfully." % ovim_cache_dir)
        except:
            print("delete config dir %s failed. please remove %s manually." % (ovim_cache_dir, ovim_cache_dir))
...
def create_arg_parser():
    ...
    # uninstall
    parser_uninstall = subparsers.add_parser('uninstall', aliases=['u'], help='uninstall vim config')
