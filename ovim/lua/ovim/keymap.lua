...
local function quit()
  ...
  for _, value in pairs(vim.api.nvim_tabpage_list_wins(0)) do
    if vim.api.nvim_buf_get_option(vim.api.nvim_win_get_buf(value), "buftype") ~= "nofile" then
      count = count + 1
    end
  end
...
local function basic()
  ...
  local maps = {
    ...
    ["n|<A-q>"] = quit_window,
        ...
        ["n|<leader>f" .. (window_opts.center or "<space>")] = map_f(function() window.float(0) end):with_display "Center",
        ["n|<leader>f" .. (window_opts.full or "g")] = map_f(function() window.float_full(0) end):with_display "Full",
        ["n|<leader>f" .. (window_opts.nw or "y")] = map_f(function() window.float_nw(0) end):with_display "NW",
        ["n|<leader>f" .. (window_opts.ne or "u")] = map_f(function() window.float_ne(0) end):with_display "NE",
        ["n|<leader>f" .. (window_opts.sw or "n")] = map_f(function() window.float_sw(0) end):with_display "SW",
        ["n|<leader>f" .. (window_opts.se or "m")] = map_f(function() window.float_se(0) end):with_display "SE",
        ["n|<leader>f" .. (window_opts.top or "k")] = map_f(function() window.float_top(0) end):with_display "Top",
        ["n|<leader>f" .. (window_opts.left or "h")] = map_f(function() window.float_left(0) end):with_display "Left",
        ["n|<leader>f" .. (window_opts.bottom or "j")] = map_f(function() window.float_bottom(0) end):with_display "Bottom",
        ["n|<leader>f" .. (window_opts.right or "l")] = map_f(function() window.float_right(0) end):with_display "Right",
        ["n|<leader>f" .. (window_opts.scale_up or "o")] = map_f(function() window.float_scale(0, 1.1, 1.1) end):with_display "Scale +",
        ["n|<leader>f" .. (window_opts.scale_down or "i")] = map_f(function() window.float_scale(0, 0.9, 0.9) end):with_display "Scale -",
        ["n|<leader>f" .. (window_opts.move_left or "[")] = map_f(function() window.float_move(0, 0, -5) end):with_display "window.veLeft",
        ["n|<leader>f" .. (window_opts.move_right or "]")] = map_f(function() window.float_move(0, 0, 5) end):with_display "window.veRight",
        ["n|<leader>f" .. (window_opts.move_up or ";")] = map_f(function() window.float_move(0, -5, 0) end):with_display "window.veUp",
        ["n|<leader>f" .. (window_opts.move_down or "'")] = map_f(function() window.float_move(0, 5, 0) end):with_display "window.veDown",
        ["n|<leader>f" .. (window_opts.reduce_width or "9")] = map_f(function() window.float_plus(0, 0, -5) end):with_display "Width -",
        ["n|<leader>f" .. (window_opts.increase_width or "0")] = map_f(function() window.float_plus(0, 0, 5) end):with_display "Width +",
        ["n|<leader>f" .. (window_opts.increase_height or ".")] = map_f(function() window.float_plus(0, 5, 0) end):with_display "Height +",
        ["n|<leader>f" .. (window_opts.reduce_height or ",")] = map_f(function() window.float_plus(0, -5, 0) end):with_display "Height -",
